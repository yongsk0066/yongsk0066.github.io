...
쨋든 다시 오일러 데이로 돌아와 보면. 정확히 무슨 강연을 들었는지는 기억나지 않지만. 아마 오일러 항등식의 아름다움을 알려주는 자리 였을 것이다. 비록 지금은 잊혀졌지만 강연을 감명깊게 듣고와서 상상을 하기 시작했다.
...
결국 타원의 둘레를 구하는 것은 **sin 함수 호의 길이**를 구하는 것과 같다.
